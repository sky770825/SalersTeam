...
function doPost(e) {
  try {
    ...
    const spreadsheet = SpreadsheetApp.openById('13YdRyVL9aBguo6TcPolVRwhlB_FEHIwIroxmC4H1zZE');
...
function checkActualConnection() {
  try {
    ...
    const currentSheetId = '13YdRyVL9aBguo6TcPolVRwhlB_FEHIwIroxmC4H1zZE';
...
function checkAllPossibleSheets() {
  try {
    ...
    const possibleSheetIds = [
      '13YdRyVL9aBguo6TcPolVRwhlB_FEHIwIroxmC4H1zZE', // 新的試算表
